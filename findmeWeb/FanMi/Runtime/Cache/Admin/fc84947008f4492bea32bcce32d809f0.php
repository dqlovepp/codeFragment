    ...
    <div id="help-div" style="display:none">
		...
		<li id="mainRight">
			<h1>
			    ...
			    <span class="action-span"><a href="/Admin/Category/categoryAdd">添加分类</a></span>
...
<form method="post" action="" name="listForm">
    <div class="list-div" id="listDiv">
        <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
            ...
            <?php if(is_array($goodsCateInfo)): foreach($goodsCateInfo as $key=>$val): ?><tr align="center" class="0">
                <td align="center" class="first-cell" >
                <?php echo ($val["category_name"]); ?>
                </td>
                <td width="15%"><?php echo ($val["navigate"]); ?></td>
                <td width="15%"><img src="<?php if($val["is_hidden"] == 0): echo (FM_ADMIN_IMG); ?>yes.gif <?php else: ?> <?php echo (FM_ADMIN_IMG); ?>no.gif<?php endif; ?>" /></td>
                <td width="30%" align="center">
                <a href="/Admin/Category/categoryEdit/category_id/<?php echo ($val["category_id"]); ?>.html">编辑</a> |
                <a href="javascript:;" title="移除" onclick="delNavigete(this,<?php echo ($val["category_id"]); ?>)">移除</a>
                </td>
