...
<div class="list-div">
    <table cellspacing='1' cellpadding='3'>
        ...
        <tr>
            <td width="20%"><a href="/findmeWeb/Admin/Order/notPost.html">待发货订单:</a></td>
            <td width="30%"><strong style="color:red"><?php echo ($detailOrder["unpost"]); ?></strong></td>
            <td width="20%"><a href="#">未确认订单:</a></td>
            <td width="30%"><strong><?php echo ($detailOrder["unsure"]); ?></strong></td>
        </tr>
        <tr>
            <td><a href="#">待支付订单:</a></td>
            <td><strong><?php echo ($detailOrder["unpay"]); ?></strong></td>
            <td><a href="#">已成交订单数:</a></td>
            <td><strong><?php echo ($detailOrder["success"]); ?></strong></td>
        </tr>
        <tr>
            <td><a href="#">退款申请:</a></td>
