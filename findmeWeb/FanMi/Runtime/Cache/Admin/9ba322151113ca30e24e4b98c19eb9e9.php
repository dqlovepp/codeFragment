...
<?php if(is_array($curfooter)): $i = 0; $__LIST__ = $curfooter;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$footer): $mod = ($i % 2 );++$i;?><div class="list-div">
    <table cellspacing='1' cellpadding='3'>
        <tr>
            <th colspan="2" class="group-title">
            <?php echo ($footer["first"]["name"]); ?></th>
        </tr> 
        <?php if(is_array($footer["second"])): $i = 0; $__LIST__ = $footer["second"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ftsecond): $mod = ($i % 2 );++$i;?><tr>
            <td width="20%"><?php echo ($ftsecond['name']); ?></td>
            <td width="80%">
            <a href="/Admin/Helpcenter/look/id/<?php echo ($ftsecond['id']); ?>.html">查看</a>
            <a href="/Admin/Helpcenter/modify/id/<?php echo ($ftsecond['id']); ?>.html">修改</a>
            </td>
