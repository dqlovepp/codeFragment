...
<div class="list-div">
    <table cellspacing='1' cellpadding='3'>
        <tr>
         ...
         <tr>
            <td>
            <?php if(empty($curhelp["child"]["content"])): ?>内容为空！
             <a href="/Admin/Helpcenter/modify/id/<?php echo ($curhelp['child']['id']); ?>.html">立即添加</a>
            <?php else: ?> 
            <?php echo (html_entity_decode(htmlspecialchars_decode($curhelp["child"]["content"]))); endif; ?>
