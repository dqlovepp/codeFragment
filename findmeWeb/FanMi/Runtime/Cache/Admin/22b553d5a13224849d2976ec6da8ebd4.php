...
#mainRight{float: left;vertical-align: top; width: auto; height: auto;}
#footer {
  clear: both;
  background: #F4FaFb;
...
$(function(){
	...
	mainRight.style.width=document.documentElement.clientWidth-mainLeft.offsetWidth-40+'px';
});
...
<script language="JavaScript">
    ...
    <span class="action-span1"><a href="/Admin/Index/index.html">泛米 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 添加品牌 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="/Admin/Brand/brandModify" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">品牌名称</td>
                <td>
                    <input type="text" name="brand_name" maxlength="60" value="<?php echo ($brand["brand_name"]); ?>" />
            ...
            <tr>
                ...
                <td>
                    <textarea  name="brand_desc" cols="60" rows="4"  ><?php echo ($brand["brand_desc"]); ?></textarea>
                </td>
            </tr>
            <tr>
