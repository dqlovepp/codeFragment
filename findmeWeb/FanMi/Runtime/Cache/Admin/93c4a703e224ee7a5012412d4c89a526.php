...
<div class="tab-div">
    <div id="tabbar-div">
        <p>
            ...
            &gt;&gt;
            <span class="tab-front" id="general-tab" style="color:#FF0000;">2.商品图片添加</span>
            &gt;&gt;
            <span class="tab-front" id="general-tab"><a href="/Admin/Goods/goodsAddStep3/id/<?php echo ($goods_id); ?>" >3.商品简介添加</a></span>
        </p>
    </div>
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/Admin/Goods/goodsAddStep2" method="post">
            <!-- 商品图片 -->
