...
<div id="main-div">
    ...
    <span class="action-span"><a href="/Admin/Goods/showlist" target="main-frame">商品列表</a>
    </span>
...
<div class="tab-div">
    <div id="tabbar-div">
        <p>
             <span class="tab-front" id="general-tab">1.商品信息添加</span>
            &gt;&gt;
            <span class="tab-front" id="general-tab"><a href="/Admin/Goods/goodsAddStep2/id/<?php echo ($goods_id); ?>" target="main-frame">2.商品图片添加</a></span>
            &gt;&gt;
            <span class="tab-front" id="general-tab" style="color:#FF0000;">3.商品简介添加</span>
        </p>
    </div>
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/Admin/Goods/goodsAddStep3" method="post">
            <table width="100%" class="spanandtable" align="center" >
                <tr>
                    <td>
