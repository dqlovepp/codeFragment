    ...
    <div id="help-div" style="display:none">
		...
		<li id="mainRight">
			<h1>
			    ...
			    <span class="action-span"><a href="/findmeWeb/Admin/Goods/showlist" target="main-frame">商品列表</a>
    </span>
...
<div class="tab-div">
    <div id="tabbar-div">
        <p>
            <span class="tab-front" id="general-tab" style="color:#FF0000;">1.商品信息添加</span>
            &gt;&gt;
            <span class="tab-front" id="general-tab">2.商品图片添加</span>
            &gt;&gt;
            <span class="tab-front" id="general-tab" >3.商品简介添加</span>
        </p>
    </div>
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/findmeWeb/Admin/Goods/goodsAdd" method="post">
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <select name="goods_category_id">
                            ...
                            <?php if(is_array($categoryinfo)): foreach($categoryinfo as $key=>$val): ?><option value="<?php echo ($val["category_id"]); ?>"><?php echo ($val["category_name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        <select name="goods_brand_id">
                            <option value="0">请选择...</option>
                            <?php if(is_array($Brandinfo)): foreach($Brandinfo as $key=>$val): ?><option value="<?php echo ($val["brand_id"]); ?>"><?php echo ($val["brand_name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="goods_market_price" value="0" size="20"/>
                        <span class="require-field">*</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="goods_is_onsale" value="1"/> 是
                        <input type="radio" name="goods_is_onsale" value="0"/> 否
                    </td>
                </tr>
                <tr>
                    <td class="label">加入推荐：</td>
                    <td>
                        <input type="checkbox" name="goods_is_best" value="1" /> 精品 
                        <input type="checkbox" name="goods_is_best" value="1" /> 新品 
                        <input type="checkbox" name="goods_is_best" value="1" /> 热销
                    </td>
                </tr>
                <tr>
                    <td class="label">推荐排序：</td>
                    <td>
                        <input type="text" name="goods_rank" size="5" value="100"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="goods_introduce" cols="40" rows="3"></textarea>
                    </td>
                </tr>
            </table>
