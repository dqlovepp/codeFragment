        ...
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    ...
                    <li class="menu-item"><a href="/Admin/Goods/goodsAdd" target="main-frame">添加新商品</a></li>
                    <li class="menu-item"><a href="/Admin/Goods/categoryList" target="main-frame">商品分类</a></li>
                    <li class="menu-item"><a href="/Admin/Goods/brandList" target="main-frame">商品品牌</a></li>
                </ul>
            </li>
