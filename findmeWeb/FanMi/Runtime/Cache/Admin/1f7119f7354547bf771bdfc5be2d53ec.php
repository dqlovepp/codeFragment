        ...
        <form enctype="multipart/form-data" action="/Admin/Goods/goodsEditing" method="post">
            <table width="90%" id="general-table" align="center" class="spanandtable" >
               ...
               <tr>
                    <td>
                        <ul>
                        <?php if(is_array($goodsPicinfo)): $i = 0; $__LIST__ = $goodsPicinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$image): $mod = ($i % 2 );++$i;?><li style="float:left;margin:5px; list-style-type: none;">
                                <img width="200" src="<?php echo (URL); ?>Public/<?php echo ($image['mid_img']); ?>" /><br />
                                <a href="javascript:;" onclick="delImg(this,<?php echo ($image['id']); ?>);">[删除]</a>
