...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/Home/Cart/lst/navType/1" class="navType">系列</a></li>
					<li><a href="/Home/Cart/lst/navType/2" class="navType">品牌</a></li>
					<li><a href="/Home/Cart/lst/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
...
<div style="clear:both;"></div>
	...
	<div class="fillin w990 bc mt15">
		...
		<form action="" method="post" name="cartOrder" id="cartOrder">
			<!-- 收货人信息  start-->
			<div class="address">
				<h3>收货人信息 </h3>
				...
				<table>
					...
					<tbody>
						<?php if(is_array($goodsinfo)): $i = 0; $__LIST__ = $goodsinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><tr>
							<td class="col1"><a href=""><img src="<?php echo (URL); ?>Public/<?php echo ($goods["goods_mid_img"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($goods["goods_name"]); ?></a></strong></td>
							<td class="col2"> 
							<p>身高：<?php echo ($orderinfo["userheight"]); ?></p>
							<p>体重：<?php echo ($orderinfo["userweight"]); ?>斤</p> 
							<p>尺码：<?php echo ($orderinfo["goods_size"]); ?></p> 
							</td>
							<td class="col3">￥<?php echo ($goods["goods_price"]); ?></td>
							<td class="col4"> <?php echo ($orderinfo["amount"]); ?></td>
							<td class="col5"><span>￥<?php echo $orderinfo['goods_price']*$orderinfo['amount']; ?></span></td>
							...
							<td colspan="5">
								<ul>
									<li>
										...
										<em>￥<?php echo $orderinfo['goods_price']*$orderinfo['amount']; ?></em>
									</li>
									<li>
										<span>运费：</span>
										<em>￥0</em>
		...
		<div class="fillin_ft">
			...
			<p>应付总额：<strong>￥<?php echo $orderinfo['goods_price']*$orderinfo['amount']; ?>元</strong></p>
