...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/findmeWeb/Home/Manager/myfm/navType/1" class="navType">系列</a></li>
					<li><a href="/findmeWeb/Home/Manager/myfm/navType/2" class="navType">品牌</a></li>
					<li><a href="/findmeWeb/Home/Manager/myfm/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
...
<div class="message">
<?php if(!empty($message)): ?><p class="cont"><?php echo ($message); ?></p><?php endif; ?>
<p>
面页面自动 <a id="href" href="<?php echo($jumpUrl); ?>">跳转</a> 等待时间： <b id="wait"><?php echo($waitSecond); ?></b>
</p>
</div>
<script type="text/javascript">
(function(){
