...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/findmeWeb/Home/Products/goodsList/navType/1" class="navType">系列</a></li>
					<li><a href="/findmeWeb/Home/Products/goodsList/navType/2" class="navType">品牌</a></li>
					<li><a href="/findmeWeb/Home/Products/goodsList/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/findmeWeb/Home/Index/Index.html">首页</a> &gt;&gt; <a href="/findmeWeb/Home/Index/Index.html">系列</a> &gt;&gt; <a href="javascript:;"><?php echo ($curNav["nav_name"]); ?></a></h2>
		</div>
		<!-- 面包屑导航 end -->
		<div style="clear:both; height:5px;"></div>
		<!-- 主体IMG展示 start-->
		<img src="<?php echo (APP_HOME_IMG); ?>fanmiBannerimg4.jpg" width="1210px" height="400px" border="0">
		<!-- 主体IMG展示 end-->
		<div style="clear:both;"></div>
		<!--分类 start-->
		<div class="footer w1210 bc mt10">
			<p class="links">
				<?php if(is_array($allCategory)): $i = 0; $__LIST__ = $allCategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i; if($category['category_id'] == $curCategory['category_id']): ?><a href="javascript:;" style="color:#666666"><?php echo ($category["category_name"]); ?> </a>
				<?php else: ?>
					<a href="/findmeWeb/Home/Products/goodsList/catalog/<?php echo ($curNav["nav_id"]); ?>/categoryid/<?php echo ($category["category_id"]); ?>.html"><?php echo ($category["category_name"]); ?> </a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
			</p>
		</div>
		<!--分类 end-->
		<div style="clear:both;"></div>
		<?php if(empty($curgoods)): ?><div style="width:100%; height:100px; color:#e00; text-align:center; line-height:30px; margin-top:50px;">
		当前没有资源
		</di>
		<?php else: ?>
		<!--分页导航 start-->
		<div class="page mt20" style="width:1210px;">
		<?php echo ($pagelist); ?>
		</div>
		<!--分页导航 end-->
		<div style="clear:both;"></div>
		...
		<div class="goodslist mt10">
			<ul>
				<?php if(is_array($curgoods)): $i = 0; $__LIST__ = $curgoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><li>
					<dl>
						<dt><a href="/findmeWeb/Home/Products/goods/catalog/<?php echo ($curCategory["navigation_id"]); ?>/Category/<?php echo ($curCategory["category_id"]); ?>/id/<?php echo ($goods["goods_id"]); ?>.html"><img src="<?php echo (URL); ?>Public/<?php echo ($goods["goods_big_img"]); ?>" alt="" /></a></dt>
						<dd><a href="/findmeWeb/Home/Products/goods/catalog/<?php echo ($curCategory["navigation_id"]); ?>/Category/<?php echo ($curCategory["category_id"]); ?>/id/<?php echo ($goods["goods_id"]); ?>.html"><?php echo ($goods["goods_name"]); ?></a></dt>
						<dd><strong>￥<?php echo ($goods["goods_price"]); ?></strong></dt>
						<dd><a href="/findmeWeb/Home/Products/goods/catalog/<?php echo ($curCategory["navigation_id"]); ?>/Category/<?php echo ($curCategory["category_id"]); ?>/id/<?php echo ($goods["goods_id"]); ?>.html"><em>已有10人评价</em></a></dt>
					</dl>
