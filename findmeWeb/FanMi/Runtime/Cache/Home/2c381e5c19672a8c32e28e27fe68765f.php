...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/Home/Novice/regist/navType/1" class="navType">系列</a></li>
					<li><a href="/Home/Novice/regist/navType/2" class="navType">品牌</a></li>
					<li><a href="/Home/Novice/regist/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
	...
	<div class="main w1210 bc mt10">
		...
		<div class="menu fl">
			...
			<div class="menu_wrap">
				<dl>
					<dt>新手指南 <b></b></dt>
					<dd><b>.</b><a href="" class="curmenua">用户注册</a></dd>
					<dd><b>.</b><a href="">会员折扣</a></dd>			
					<dd><b>.</b><a href="">用户奖励</a></dd>
					<dd><b>.</b><a href="">常见问题</a></dd>
				</dl>
				<dl>
					<dt>购物指南<b></b></dt>
					<dd><b>.</b><a href="">新手必读</a></dd>
					<dd><b>.</b><a href="">购物流程</a></dd>
					<dd><b>.</b><a href="">订单状态</a></dd>
				</dl>
				<dl>
					<dt>付款方式<b></b></dt>
					<dd><b>.</b><a href="">支付方式</a></dd>
					<dd><b>.</b><a href="">使用条款</a></dd>
					<dd><b>.</b><a href="">免责声明</a></dd>
				</dl>
				<dl>
					<dt>配送方式<b></b></dt>
					<dd><b>.</b><a href="">配送方式</a></dd>
					<dd><b>.</b><a href="">订单出库</a></dd>
					<dd><b>.</b><a href="">配送和验收</a></dd>
				</dl>
				<dl>
					<dt>售后指南<b></b></dt>
					<dd><b>.</b><a href="">注册协议</a></dd>
					<dd><b>.</b><a href="">隐私保护</a></dd>
					<dd><b>.</b><a href="">退换货保障</a></dd>
				</dl>
			</div>
		</div>
		<!-- 左侧导航菜单 end -->
