...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/findmeWeb/Home/Fkfanshi/fkfmodel/navType/1" class="navType">系列</a></li>
					<li><a href="/findmeWeb/Home/Fkfanshi/fkfmodel/navType/2" class="navType">品牌</a></li>
					<li><a href="/findmeWeb/Home/Fkfanshi/fkfmodel/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
	...
	<div class="main w1210 bc mt10">
		...
		<div class="menu fl">
			<h3>帮助中心</h3>
			<div class="menu_wrap">
				<?php if(is_array($footers)): $i = 0; $__LIST__ = $footers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$footer): $mod = ($i % 2 );++$i;?><dl>
					<dt><?php echo ($footer["first"]["name"]); ?><b></b></dt>
					<?php if(is_array($footer["second"])): $i = 0; $__LIST__ = $footer["second"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ftsecond): $mod = ($i % 2 );++$i;?><dd><b>.</b><a href="/findmeWeb/Home/<?php echo ($footer["first"]["cname"]); ?>/<?php echo ($ftsecond["cname"]); ?>.html"><?php echo ($ftsecond["name"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="content fl ml10">
			<div class="user_hd">
				<h3><?php echo ($curfooter["name"]); ?></h3>
			</div>

			<div class="user_bd mt10">
				<?php echo (html_entity_decode(htmlspecialchars_decode($curfooter["content"]))); ?>
			</div>
		</div>
		<!-- 右侧内容区域 end -->
	</div>
