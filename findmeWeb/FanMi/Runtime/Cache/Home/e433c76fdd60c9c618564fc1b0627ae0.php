...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/Home/Manager/consume/navType/1" class="navType">系列</a></li>
					<li><a href="/Home/Manager/consume/navType/2" class="navType">品牌</a></li>
					<li><a href="/Home/Manager/consume/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
	...
	<div class="main w1210 bc mt10">
		...
		<div class="menu fl">
			...
			<div class="menu_wrap">
				<dl>
					...
					<dd><b>.</b><a href="/Home/Manager/consume/id/<?php echo ($userinfo["user_id"]); ?>.html" class="curmenua">消费记录</a></dd>
		...
		<div class="content fl ml10">
			...
			<div class="envelope">
				...
				<?php if(empty($history)): ?>暂无消费记录
				<?php else: ?>
					<ul>
						<li class="title">消费记录</li>
						<?php if(is_array($history)): $i = 0; $__LIST__ = $history;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$consume): $mod = ($i % 2 );++$i;?><li><p><?php echo ($consume["consume_time"]); ?>，您购买了 <?php echo ($consume["goods_name"]); ?> 商品，消费<?php echo ($consume["goods_price"]); ?>元</p>
						<?php if($consume["goodsinfo"] == ''): ?><a href="javascript:;">商品已下架</a>
						<?php else: ?>
						<a href="/Home/Products/goods/id/<?php echo ($consume["goodsinfo"]["goods_id"]); ?>.html">查看商品</a><?php endif; ?>						
