...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/findmeWeb/Home/User/login/navType/1" class="navType">系列</a></li>
					<li><a href="/findmeWeb/Home/User/login/navType/2" class="navType">品牌</a></li>
					<li><a href="/findmeWeb/Home/User/login/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
	...
	$(function(){
		$('#changeImg').click(function(){
			$('#verifyImg').attr("src","/findmeWeb/Home/User/verifyImg/"+Math.random());
		});
		
		//验证
		$("#login_btn").click(function(){
			if(checkSubmit({username:"用户名不可为空",password:"",checkcode:""}))
			{
				$(".login_form form").submit();
				$(this).attr("action","/Home/User/login");
			}
		});
	});
	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
				...
				<form method="post">
					<ul>
						...
						<li>
							...
							<span></span>
							<a href="/findmeWeb/Home/User/seekpw.html">忘记密码?</a>
						</li>
						<li class="checkcode">
							<label for="">验证码：</label>
							<input type="text"  name="checkcode" id="checkcode" />
							<img src="/findmeWeb/Home/User/verifyImg" alt="" id="verifyImg" onclick="this.src='/findmeWeb/Home/User/verifyImg?'+Math.random()"/>
						...
						<li>
							<label for="">&nbsp;</label>
							<a href="javascript:;"  id="login_btn"></a>
						</li>
					</ul>
				</form>
			...
			<div class="guide fl">
				...
				<a href="/findmeWeb/Home/user/register" class="reg_btn">免费注册 >></a>
			</div>
