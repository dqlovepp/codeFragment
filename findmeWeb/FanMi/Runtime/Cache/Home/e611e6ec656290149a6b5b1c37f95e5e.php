...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/Home/Cart/buynow/navType/1" class="navType">系列</a></li>
					<li><a href="/Home/Cart/buynow/navType/2" class="navType">品牌</a></li>
					<li><a href="/Home/Cart/buynow/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
...
<script type="text/javascript" src="<?php echo (URL); ?>Public/cxselect/jquery.cxselect.min.js">
</script>
<script>
$(function(){
...
<script type="text/javascript" src="<?php echo (FM_HOME_JS); ?>cart2.js"></script>
	...
	<div class="noticeLogin">
		<ul>
			...
			<li><a class="go_login_btn" href="/Home/User/login.html" title="马上登入">马上登入</a></li>
		</ul>       
    </div>
	<!-- 登录提醒 end -->
	...
	<div class="fillin w990 bc mt15">
		...
		<?php if(empty($_SESSION['fm_user_id'])): ?><!-- 收货人信息  start-->
			...
			<div class="goods">
				...
				<table>
					...
					<tbody>
						<tr>
							<td class="col1"><a href=""><img src="<?php echo (URL); ?>Public/<?php echo ($goodsinfo["goods_mid_img"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($goodsinfo["goods_name"]); ?></a></strong></td>
							<td class="col2"> 
							<p>身高：<?php echo ($orderinfo["userheight"]); ?></p>
							<p>体重：<?php echo ($orderinfo["userweight"]); ?>斤</p> 
							<p>尺码：<?php echo ($orderinfo["goods_size"]); ?></p> 
							</td>
							<td class="col3">￥<?php echo ($goodsinfo["goods_price"]); ?>.00</td>
							<td class="col4"><?php echo ($orderinfo["amount"]); ?></td>
							<td class="col5"><span>￥<?php echo $orderinfo['amount']*$goodsinfo['goods_price']; ?>.00</span></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
							<td colspan="5">
								<ul>
									<li>
										<span> <?php echo ($orderinfo["amount"]); ?>件商品，总商品金额：</span>
										<em><?php echo $orderinfo['amount']*$goodsinfo['goods_price']; ?>.00￥</em>
									</li>
									<li>
										<span>运费：</span>
										<em>￥0</em>
		...
		<div class="fillin_ft">
			...
			<p>应付总额：<strong><?php echo $orderinfo['amount']*$goodsinfo['goods_price']; ?>.00￥元</strong></p>
