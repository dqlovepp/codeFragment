...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/Home/Story/myStory/navType/1" class="navType">系列</a></li>
					<li><a href="/Home/Story/myStory/navType/2" class="navType">品牌</a></li>
					<li><a href="/Home/Story/myStory/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
