...
<div id="header_cont">
	...
	<?php switch($layoutType): case "Empty": break;?> 
		...
		<div style="width:899px; height:80px;">
			...
			<div class="navigator-type">
				<ul>
					<li><a href="/findmeWeb/Home/Index/index/navType/1" class="navType">系列</a></li>
					<li><a href="/findmeWeb/Home/Index/index/navType/2" class="navType">品牌</a></li>
					<li><a href="/findmeWeb/Home/Index/index/navType/3" class="navType">服务</a></li>
				</ul>
			</div>
		</div>
			<div id="navigator-box">
 ...
 <div id='main_content'>
	<div id="wrapper_box">
		<ul id="wrapper_imgs">
			<li><a href="" target=""><img src="<?php echo (APP_HOME_IMG); ?>fanmiBannerimg1.jpg" width="1400px" height="600px" border="0"></a></li>
			<li><a href="" target=""><img src="<?php echo (APP_HOME_IMG); ?>fanmiBannerimg2.jpg" width="1400px" height="600px" border="0"></a></li>
			<li><a href="" target=""><img src="<?php echo (APP_HOME_IMG); ?>fanmiBannerimg3.jpg" width="1400px" height="600px" border="0"></a></li>
			<li><a href="" target=""><img src="<?php echo (APP_HOME_IMG); ?>fanmiBannerimg4.jpg" width="1400px" height="600px" border="0"></a></li>
			<li><a href="" target=""><img src="<?php echo (APP_HOME_IMG); ?>fanmiBannerimg5.jpg" width="1400px" height="600px" border="0"></a></li>
		</ul>
		<div id="dot-wrapper">
			<ul>
